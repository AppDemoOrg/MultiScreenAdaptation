...
密度DPI=480   xxxhdpi    密度3.0              values-wNdp(N=Width/密度)         (@dimen/dp_N)=Ydp(Y=PX/密度,N随Y变)                
密度DPI=400   xxhdpi     密度2.5              values-wNdp(N=Width/密度)         (@dimen/dp_N)=Ydp(Y=PX/密度,N随Y变)           
密度DPI=320   xhdpi      密度2.0              values-wNdp(N=Width/密度)         (@dimen/dp_N)=Ydp(Y=PX/密度,N随Y变)            
密度DPI=240   hdpi       密度1.5              values-wNdp(N=Width/密度)         (@dimen/dp_N)=Ydp(Y=PX/密度,N随Y变)             
密度DPI=160   mdpi       密度1.0（基准）       values-wNdp(N=Width/密度)         (@dimen/dp_N)=Ydp(Y=PX/密度,N随Y变)            
密度DPI=120   ldpi       密度0.75             values-wNdp(N=Width/密度)         (@dimen/dp_N)=Ydp(Y=PX/密度,N随Y变)          
